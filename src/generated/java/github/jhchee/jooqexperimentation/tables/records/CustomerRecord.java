...
public class CustomerRecord extends UpdatableRecordImpl<CustomerRecord> implements Record3<UUID, String, String> {
     ...
     */
    public CustomerRecord setMetadata(String value) {
        set(2, value);
        return this;
    }
    ...
    @Override
    public CustomerRecord values(UUID value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public CustomerRecord(UUID id, String email, String metadata) {
        super(Customer.CUSTOMER);
